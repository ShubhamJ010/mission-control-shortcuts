...
final class ShortcutConfigurationTests: XCTestCase {
    ...
    func testDefaultBindingsMatchShippedDefaults() {
        ...
        XCTAssertNil(config.binding(for: .leftHalfSnap))
        XCTAssertNil(config.binding(for: .rightHalfSnap))
        XCTAssertNil(config.binding(for: .leftThirdSnap))
        XCTAssertNil(config.binding(for: .rightThirdSnap))
