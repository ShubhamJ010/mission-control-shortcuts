...
final class SettingsWindowController: NSWindowController {
    ...
    convenience init(viewModel: ShortcutViewModel) {
        self.init(panes: [
            ...
            WindowShortcutsPane(viewModel: viewModel,
                                tabName: "Windows",
                                tabImage: NSImage(systemSymbolName: "macwindow", accessibilityDescription: nil),
                                tabIdentifier: "windows"),
            AppShortcutsPane(viewModel: viewModel,
                             tabName: "App",
                             tabImage: NSImage(systemSymbolName: "app", accessibilityDescription: nil),
                             tabIdentifier: "app"),
